...
function Book(book : IBook) {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg w-64 flex flex-col relative hover:scale-105 transition-transform duration-300">
      <div className="h-52 overflow-hidden rounded-t-lg transition-all duration-300">
      <img 
        src={book.cover} 
        alt={book.title} 
        className="w-full h-full object-cover rounded-t-lg scale-110 hover:scale-100 transition-all duration-300"
      />
      </div>
